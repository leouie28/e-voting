                ...
                <v-stepper v-model="step">
                    ...
                    <v-stepper-items>
                        <v-stepper-content step="1">
                            ...
                            ></step-1>
                            <div v-if="!isShow">
                                <v-btn color="primary" @click="saveLocal(2)">
                        ...
                        <v-stepper-content step="2">
                            ...
                            ></step-2>
                            <div v-if="!isShow">
                                <v-btn color="primary" @click="saveLocal(3)">
                                    {{ isShow ? "Next" : "Continue" }}
                                </v-btn>
...
export default {
    ...
    methods: {
        cancelEdit() {
            axios
                .get(`/admin-api/election/get-set/${this.payload.election.id}`)
                .then(({ data }) => {
                    this.payload = data;
                });
        },
